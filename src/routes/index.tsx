    ...
    <section id="home" className="pt-36 pb-16 text-center px-4">
      ...
      <div className="mt-10 max-w-xl mx-auto glow-card rounded-3xl p-6 text-left">
        ...
        <div className="flex items-center gap-2 rounded-2xl bg-background/50 border border-border px-4 py-3">
          ...
          />
          <button className="text-xs font-medium text-primary">Ask →</button>
        </div>
      </div>
    </section>
  );
    ...
    <section id="about" className="max-w-5xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-5">
      ...
      <div className="glow-card rounded-3xl p-6 md:col-span-2 flex flex-wrap items-center gap-4 justify-between">
        <div>
          ...
          <p className="font-semibold text-lg mt-1">San Francisco, CA</p>
        </div>
        <div className="flex items-center gap-2 text-sm">
          <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
          <span className="text-muted-foreground">Available for AI engineering work</span>
        </div>
      </div>
    </section>
  );
